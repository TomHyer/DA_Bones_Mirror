...
double JNI::ToDouble(JNIEnv*, jdouble src)
{
	return src;
}
boost::optional<double> JNI::ToDouble(JNIEnv*, jdouble src, bool)
{
	return src;	// not really optional at this point
}

int JNI::ToInt(JNIEnv* jenv, jint src)
{
	return src;
}
boost::optional<int> JNI::ToInt(JNIEnv* jenv, jint src, bool optional)
{
	return src;	// not really optional at this point
}

bool JNI::ToBool(JNIEnv* jenv, jboolean src)
{
	return !!src;
}
boost::optional<bool> JNI::ToBool(JNIEnv* jenv, jboolean src, bool optional)
{
	return !!src;	// not really optional at this point
}
...
Date_ JNI::ToDate(JNIEnv* jenv, const jobject src, bool optional)
{
	return ToDateTime(jenv, src, optional).Date();
}
...
namespace
{
	template<class J_, class E_, class T_> auto JNI__ToVector
		(JNIEnv* jenv,
		 const J_ src,
		 const E_ GET_ATlement,
		 const T_ translate,
		 bool optional)
	...
	static const auto GET_AT = [](JNIEnv* jenv, jobjectArray src, int ii) {return jenv->GetObjectArrayElement(src, ii); };

	JNI::HDict_ ToHDictionary(JNIEnv* jenv, const jobject src) 
	{ 
		return JNI::HDict_(); 
	}
}	// leave local
...
{
	static const auto TRANSLATE = [](JNIEnv* jenv, jobject obj) {return ToString(jenv, reinterpret_cast<jstring>(obj), false); };
...
{
	static const auto TRANSLATE = [](JNIEnv* jenv, jobject obj) {return ToDoubleVector(jenv, static_cast<jdoubleArray>(obj), false); };
...
{
	static const auto TRANSLATE = [](JNIEnv* jenv, jobject obj) {return ToStringVector(jenv, static_cast<jobjectArray>(obj), false); };
	auto vv = JNI__ToVector(jenv, src, GET_AT, TRANSLATE, optional);
	return Matrix::FromVectors(vv, false, false);
}
Matrix_<Cell_> JNI::ToCellMatrix(JNIEnv* jenv, const jobjectArray src, bool optional)
{
	static const auto TRANSLATE = [](JNIEnv* jenv, jobject obj) {return ToCellVector(jenv, static_cast<jobjectArray>(obj), false); };
	auto vv = JNI__ToVector(jenv, src, GET_AT, TRANSLATE, optional);
	return Matrix::FromVectors(vv, false, false);
}
...
jstring JNI::CopyOut(JNIEnv* jenv, const String_& src)
{
	return jenv->NewStringUTF(src.c_str());
}

jobject JNI::CopyOut(JNIEnv* jenv, const Date_& src)
{
	return CopyOut(jenv, DateTime_(src));
}
...
jobject JNI::CopyOut(JNIEnv* jenv, const Cell_& src)
{
	...
	case Cell_::Type_::BOOLEAN:
		return jenv->NewObject(THE_CLASS, INIT_BOOL, src.b_);
	case Cell_::Type_::DATE:
	case Cell_::Type_::DATETIME:
		return jenv->NewObject(THE_CLASS, INIT_DATETIME, CopyOut(jenv, src.dt_));
	case Cell_::Type_::EMPTY:
		return jenv->NewObject(THE_CLASS, INIT_EMPTY);
	case Cell_::Type_::NUMBER:
		return jenv->NewObject(THE_CLASS, INIT_NUMBER, src.d_);
	case Cell_::Type_::STRING:
		return jenv->NewObject(THE_CLASS, INIT_STRING, CopyOut(jenv, src.s_));
	default:
		THROW("Unrecognized cell type");
	}
}
...
jobjectArray JNI::CopyOut(JNIEnv* jenv, const Vector_<String_>& src)
{
	return CopyOutVector(jenv, src);
}
jobjectArray JNI::CopyOut(JNIEnv* jenv, const Vector_<Cell_>& src)
{
	return CopyOutVector(jenv, src);
}
...
jobjectArray JNI::CopyOut(JNIEnv* jenv, const Matrix_<>& src)
{
	return CopyOutMatrix(jenv, src);
}
jobjectArray JNI::CopyOut(JNIEnv* jenv, const Matrix_<String_>& src)
{
	return CopyOutMatrix(jenv, src);
}
jobjectArray JNI::CopyOut(JNIEnv* jenv, const Matrix_<Cell_>& src)
{
	return CopyOutMatrix(jenv, src);
}
